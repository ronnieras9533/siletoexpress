          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Button 
                ...
                onClick={() => handleSocialClick('https://www.facebook.com/profile.php?id=61578190423738')}
              >
              ...
              <Button 
                ...
                size="sm" 
                className="text-gray-300 hover:text-white p-2"
                onClick={() => handleSocialClick('https://x.com/siletoexpress')}
              >
              ...
              <Button 
                ...
                size="sm" 
                className="text-gray-300 hover:text-white p-2"
                onClick={() => handleSocialClick('https://www.instagram.com/siletoexpress/')}
              >
              ...
              <Button 
                ...
                size="sm" 
                className="text-gray-300 hover:text-white p-2"
                onClick={() => handleSocialClick('https://www.tiktok.com/@siletoexpress')}
              >
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">siletoexpress@gmail.com</span>
              </div>
              <div className="flex items-start">
