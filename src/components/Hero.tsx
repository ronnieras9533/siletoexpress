        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-4 gap-3 sm:gap-2 mt-6 sm:mt-4">
              ...
              <div className="flex flex-col items-center text-center">
                <Truck className="h-5 w-5 sm:h-4 sm:w-4 text-blue-200 mb-1.5 sm:mb-1" />
                <h3 className="font-semibold text-xs sm:text-2xs mb-1 sm:mb-0.5">
                  Fast
                </h3>
              </div>
              <div className="flex flex-col items-center text-center">
                <Clock className="h-5 w-5 sm:h-4 sm:w-4 text-blue-200 mb-1.5 sm:mb-1" />
                <h3 className="font-semibold text-xs sm:text-2xs mb-1 sm:mb-0.5">
                  24/7
                </h3>
              </div>
              <div className="flex flex-col items-center text-center">
                <Award className="h-5 w-5 sm:h-4 sm:w-4 text-blue-200 mb-1.5 sm:mb-1" />
                <h3 className="font-semibold text-xs sm:text-2xs mb-1 sm:mb-0.5">
                  Licensed
                </h3>
              </div>
